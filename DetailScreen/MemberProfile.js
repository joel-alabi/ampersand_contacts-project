        ...
        return (
            ...
            <View style={styles.Info}>
               <View style={styles.profile}>
                <Image source={require('../assets/derick-mckinney-eyFbjKWlR2g-unsplash.jpg')} style={styles.image} />
                <View style={styles.profiledetails}>
                    <Text style={{ fontWeight: "bold", fontSize: 20, marginBottom: 5 }}>Larry Hutchson</Text>
                    <Text style={{ fontWeight: "400", fontSize: 17,color:'gray' }}>Sales Executive</Text>
                </View>
            </View>
